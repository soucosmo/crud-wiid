                ...
                <div class="card-body">
                    <form method="POST" action="/user">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="document" value="{{$user->document}}" type="text" class="form-control @error('document') is-invalid @enderror" name="document" value="{{ old('document') }}" required autocomplete="document">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birth" value="{{$user->birth}}" type="date" class="form-control @error('birth') is-invalid @enderror" name="birth" value="{{ old('birth') }}" required autocomplete="birth">
                            ...
                            <div class="col-md-6">
                                <select id="state" class="form-control text-capitalize">
                                    ...
                                    @foreach($states as $state)
                                        <option value="{{$state->id}}" {{$state->id == $user->city->state_id ? 'selected' : ''}}>{{$state->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
