            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/user">
                        ...
                        <div class="form-group row">
                            <label for="document" class="col-md-4 col-form-label text-md-right">{{ __('CPF') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="birth" class="col-md-4 col-form-label text-md-right">{{ __('Data Nasc.') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="state" class="form-control text-capitalize">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="city" name="city_id" class="form-control text-capitalize">
                                    <option selected>Selecione um estado antes</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="/home" class="btn btn-block btn-success text-ligth">
                                    {{ __('Voltar a home') }}
                                </a>
                            </div>
                        </div>
